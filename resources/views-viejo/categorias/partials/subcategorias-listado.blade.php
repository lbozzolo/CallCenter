...
<ul class="list-group">
    ...
    @forelse($subcategorias as $categoria)
        <li class="list-group-item">
            ...
            {!! $categoria->nombre !!}
            <small class="text-success"><i class="fa fa-arrow-right"></i> ({!! $categoria->parent->nombre !!})</small>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i class="fa fa-warning "></i> Eliminar subcategoría</h4>
                    </div>
                    <div class="modal-body">
                        <p class="text-danger">
                            Usted está a punto de eliminar la subcategoría '{!! $categoria->nombre !!}' devinitivamente<br>
