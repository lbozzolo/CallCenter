...
<ul class="list-group">
    ...
    <div class="card-body">
            ...
            <table class="table student-data-table m-t-20">
                ...
                <tbody>
                    <tr>
                        ...
                        <td ></td>
                        <td>
                            <button type="button" title="Eliminar" class=" btn btn-danger btn-xs" data-toggle="modal" data-target="#"><i class="fa fa-trash-o"></i></button>
        ...
        <div class="modal fade col-lg-4 col-lg-offset-8" id="#">
            <div class="card">
