    ...
    <div class="col-lg-10 col-lg-offset-1">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
            <ul class="nav navbar-nav">
                ...
                <li><a href="{{ route('llamadas.seleccion.cliente') }}" class="{{ (Request::is('llamadas/llamar'.'*') ? 'navbar-item-selected' : '') }}"><i class="fa fa-phone-square text-success"></i> Llamar</a></li>
            </ul>
        </div>
    </div>
</nav>
