        ...
        @foreach($productos as $producto)
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <a href="{{ route('productos.show', $producto->id) }}" title="Info"><i class="fa fa-info-circle"></i> </a>
                    <a href="{{ route('productos.edit', ['id' => $producto->id]) }}" title="Editar"><i class="glyphicon glyphicon-edit"></i></a>

                    <button type="button" title="ELIMINAR" class="nonStyledButton" data-toggle="modal" data-target="#eliminarProducto{!! $producto->id !!}" >
