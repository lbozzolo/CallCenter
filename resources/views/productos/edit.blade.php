                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('categorias_id[]', $categorias, $producto->categorias->lists('pivot.categoria_id')->toArray(),['multiple', 'id' => 'categorias', 'class' => 'select22 form-control', 'style' => 'width: 100%']) !!}
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="pull-right">
                                    <a href="{{ route('productos.etapas', $producto->id) }}" style="color: cyan">Configurar etapas</a> |
                                    <a href="{{ route('productos.imagenes', $producto->id) }}" style="color: cyan">Administrar imágenes</a>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::select('institucion_id', $instituciones, $producto->institucion_id, ['class' => 'form-control select2', 'placeholder' => '']) !!}
