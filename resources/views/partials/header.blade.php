<div class="header">
    ...
    <div class="pull-right p-r-15">
        <ul>
            ...
            @else
                <li class="header-icon dib"><img class="avatar-img" src="{{ asset('template/images/avatar/1.jpg') }}" alt="" /> <span class="user-avatar">Bozzolo, Lucas <i class="ti-angle-down f-s-10"></i></span>
            @endif
