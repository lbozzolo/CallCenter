...
class Entity extends Model
{
    ...
    {
        return ['marca','banco', 'asignacion', 'categoria', 'cliente', 'datoTarjeta', 'ticket', 'etapa', 'formaPago', 'imagen', 'institucion', 'noticia', 'metodoPago', 'producto', 'promocion', 'reclamo', 'updateable', 'user', 'venta',];
    }
